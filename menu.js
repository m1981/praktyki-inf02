document.addEventListener("DOMContentLoaded", function() {
    ...
    const isSubfolder = path.includes('/01-sieci/') || path.includes('/02-windows/') || path.includes('/03-linux/') || path.includes('/04-sprzet/') || path.includes('/05-excel/');
    ...
    if (isSubfolder && !path.endsWith('index.html')) {
        ...
        if (path.includes('01-sieci')) { pillarName = "🟢 Filar 1: Sieci"; pillarLink = "index.html"; }
        if (path.includes('02-windows')) { pillarName = "🪟 Filar 2: Windows"; pillarLink = "index.html"; }
        if (path.includes('03-linux')) { pillarName = "🐧 Filar 3: Linux"; pillarLink = "index.html"; }
